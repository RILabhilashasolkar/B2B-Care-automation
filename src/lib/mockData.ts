...
export const mockCustomerTickets: Ticket[] = [
  ...
  },
  {
    ...
    type: "customer",
    category: "Order Issues",
    subcategory: "Wrong Item Received",
    subSubcategory: "Exchange Required",
    status: "Open",
    priority: "High",
    ...
    orderId: "BB67BDC1E80E074386E2",
    timeline: [
      { id: "1", type: "created", description: "Order complaint raised by retailer on behalf of customer", timestamp: "2024-12-22T09:00:00", actor: "Retailer" },
    ],
  },
  {
    id: "TKT-C-005",
    ...
    status: "In Progress",
    priority: "Medium",
    description: "Customer's Whirlpool Refrigerator delivery delayed by 4 days. Customer requesting update.",
    ...
    orderId: "BB67BDC1E80E074386E2",
    timeline: [
      { id: "1", type: "created", description: "Delivery delay complaint raised", timestamp: "2024-12-21T15:00:00", actor: "Retailer" },
      { id: "2", type: "comment", description: "Checking with logistics partner for updated ETA", timestamp: "2024-12-22T10:00:00", actor: "Logistics Support" },
    ],
  },
  {
    id: "TKT-C-006",
    type: "customer",
    category: "Complaint Against Service",
    subcategory: "Technician Behavior",
    subSubcategory: "No Show",
    status: "Open",
    priority: "High",
    description: "Scheduled technician visit for AC service did not happen. Customer took day off for this.",
    ...
    assignedTo: "Technical Support",
    timeline: [
      { id: "1", type: "created", description: "Complaint against technician no-show raised", timestamp: "2024-12-23T11:00:00", actor: "Retailer" },
    ],
  },
];
